{% include "postzaviago/postzaviago/page/posapp/onscan.js" %}
frappe.pages['posapp'].on_page_load = function (wrapper) {
	...
	$("head").append("<link href='/assets/postzaviago/node_modules/vuetify/dist/vuetify.min.css' rel='stylesheet'>");
